<?php
/**
 * Nav Menu API: Maalouf_Nav_Walker class
 *
 * Extends WP's Walker Nav Menu
 * Extended to add megamenu as subitems.
 */
 ...
 * @see Walker
 */
class Maalouf_Nav_Walker extends Walker_Nav_Menu {
	/**
	...
	public function start_lvl( &$output, $depth = 0, $args = null ) {
		...
		$dropdown_icon = ( in_array( 'sub-menu', $classes ) ) ? '<span class="dropdown"></span>' : '';

		$output .= "{$dropdown_icon}{$n}{$indent}<ul$class_names>{$n}";
	}
	...
	public function start_el( &$output, $data_object, $depth = 0, $args = null, $current_object_id = 0 ) {
        ...
        // echo '<pre>';var_dump($args->walker->has_children);echo '</pre>';
		/**
        ...
        $enable_megamenu = get_field( 'menu_item_enable_megamenu', $menu_item->ID );
